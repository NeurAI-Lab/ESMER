...
class ContinualDataset:
    ...
    def get_data_loaders(self) -> Tuple[DataLoader, DataLoader]:
        """
        Creates and returns the training and test.sh loaders for the current task.
        The current training loader and all test.sh loaders are stored in self.
        :return: the current training and test.sh loaders
        """
        pass
...
def store_noisy_masked_loaders(train_dataset: datasets, test_dataset: datasets, setting: ContinualDataset, corrupt_prob=0) -> Tuple[DataLoader, DataLoader]:
    ...
    orig_labels = deepcopy(train_dataset.targets)
